...
SWEP.SlotPos = 2
if CLIENT then
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/HUD/swep_radio")
end
...
function SWEP:Initialize()
	...
	self.freq = 900 --Default freqeunz (devide 10 || default = 900)
	...
	self.freq_max = 1400 --Max frequenz (default = 900)
